...
const App: React.FC = () => {
  ...
  const loadMore = (): void => {
    ...
    setTimeout(() => {
      setVisibleItems((prev) =>
        Math.min(prev + ITEMS_PER_PAGE, filteredTemplates.length),
      );
      setLoading(false);
    }, 500);
  };
  ...
  const visibleTemplates: TemplateData[] = filteredTemplates.slice(
    0,
    visibleItems,
  );
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="flex-1 w-full mx-auto px-2 py-4">
        ...
        <TemplateGrid templates={visibleTemplates} loading={loading} />
      </main>
