...
const DetailPage: React.FC = () => {
  ...
  const template = portfolios.find((t) => t.id === Number(id));
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              {template.tags.map((tag) => (
                <span key={tag} className="px-3 py-1 text-xs rounded-md bg-muted text-muted-foreground border border-border">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div className="space-y-4">
            <div className="rounded-xl bg-card border border-border p-5 space-y-4">
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Live Website</p>
                <a
                  href={template.url}
                  target="_blank"
              ...
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Platform</p>
              ...
              {template.gallery.length > 1 && (
                <div>
                  <p className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Media</p>
                  <p className="text-sm">
