...
export const websitePortfolios: Omit<PortfolioItem, "id">[] = [
  entry("Kontraktor Surabaya", "website", C.SERVICES, kontraktorSurabayaCover,
  ...
  entry("Wase Bumi Indonesia", "website", C.BUSINESS, waseBumiIndonesiaCover,
  ...
  entry("Cubicle Toilet", "website", C.SERVICES, cubicleToiletCover,
  ...
  entry("PT. Adikarya Pesona Intinusa", "website", C.EDUCATION, adiKaryaPesonaCover,
  ...
  entry("Wreative Store", "website", C.ECOMMERCE, wreativeStoreCover,
    ...
    ["WordPress", "WooCommerce", "Payment Gateway"], wreativeStoreGallery),
  entry("Home Baraka", "website", C.SERVICES, homeBarakaCover,
  ...
  entry("Wreative", "website", C.BUSINESS, wreativeCover,
    "https://wreative.com/",
    ...
    ["WordPress", "Custom Theme", "GSAP"], wreativeGallery),
  entry("Fajar Florist", "website", C.FLORIST, fajarFloristCover,
    ...
    ["WordPress", "WooCommerce", "Custom Theme"], fajarFloristGallery),
  entry("First Media Surabaya", "website", C.SERVICES, firstMediaSurabayaCover,
  ...
  entry("DPU Bina Marga Musi", "website", C.GOVERNMENT, DPUBinaMargaMusiCover,
  ...
  entry("Chicken Explorer", "website", C.ECOMMERCE, chickenExplorerCover,
  ...
  entry("Kurir Pulsa", "website", C.ECOMMERCE, kurirPulsaCover,
  ...
  entry("Panji Semesta", "website", C.BUSINESS, panjiSemestaCover,
  ...
  entry("Dzata Lombok Transport", "website", C.SERVICES, dzataLombokTransportCover,
  ...
  entry("Pernikahan Ini", "website", C.SERVICES, pernikahanIni,
  ...
  entry("Pos Satpam", "website", C.SERVICES, posSatpam,
  ...
  entry("Toilet Portabel", "website", C.SERVICES, toiletPortabel,
  ...
  entry("PT Modern Coco International", "website", C.BUSINESS, ptModernCocoInternational,
  ...
  entry("Spesialis Karangan Bunga Indonesia", "website", C.FLORIST, spesialisKaranganBungaIndonesiaCover,
  ...
  entry("BE MODE Indonesia", "website", C.ECOMMERCE, bemodeCover,
  ...
  entry("SG Academy", "website", C.EDUCATION, sgAcademyCover,
  ...
  entry("Roby Saputra Grup", "website", C.BUSINESS, robySaputraGrupCover,
  ...
  entry("Sakpattana Jawa Timur", "website", C.BUSINESS, sakpattanaJawaTimurCover,
  ...
  entry("CV Putra Kubota", "website", C.BUSINESS, CVPutraKubotaCover,
  ...
  entry("Wahyu Dewanagari", "website", C.BUSINESS, wahyuDewanagariCover,
  ...
  entry("Aviso", "website", C.BUSINESS, avisoCover,
  ...
  entry("LPK Furinkazan", "website", C.EDUCATION, lpkFurinkazanCover,
