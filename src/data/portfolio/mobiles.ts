...
export const mobilePortfolios: Omit<PortfolioItem, "id">[] = [
  entry(
    "Wreative App", "mobile", C.BUSINESS, wreativeCover,
    "https://wreative.com/",
  ...
  entry(
    "FoodDash — Food Delivery", "mobile", C.ECOMMERCE, chickenExplorerCover,
  ...
  entry(
    "WeddingKu — Wedding Planner", "mobile", C.SERVICES, pernikahanIni,
  ...
  entry(
    "LombokRide — Transport Booking", "mobile", C.SERVICES, dzataLombokTransportCover,
  ...
  entry(
    "SG Academy Mobile", "mobile", C.EDUCATION, sgAcademyCover,
  ...
  entry(
    "BE MODE — Fashion Shopping", "mobile", C.ECOMMERCE, bemodeCover,
